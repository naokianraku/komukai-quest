...
export const TYPE_LABEL = {
  buka: '部下', senpai: '先輩', staff: 'スタッフ', dr: '設計審査', exctrl: '輸出管理', kyaku: '客', vendor: 'ベンダー', ally: '味方',
};
export const TYPE_COLOR = {
  buka: '#cfe6f5', senpai: '#f2c53d', staff: '#aab0b8', dr: '#ff5a5a', exctrl: '#8c9eff', kyaku: '#e0736a', vendor: '#7fa8d0', ally: '#46c47e',
};
